...
public class PriceVolumeDemo1 extends ApplicationFrame {
    ...
    private static JFreeChart createChart() {
        ...
        renderer1.setToolTipGenerator(new StandardXYToolTipGenerator(
                ...
                new SimpleDateFormat("yyyy年MM月dd日"), new DecimalFormat("0.00")));

        NumberAxis rangeAxis2 = new NumberAxis("vo");
        ...
        renderer2.setToolTipGenerator(
            new StandardXYToolTipGenerator(
                StandardXYToolTipGenerator.DEFAULT_TOOL_TIP_FORMAT,
                new SimpleDateFormat("yyyy年MM月dd日"), new DecimalFormat("0,000.00")
            )
        );
    ...
    private static IntervalXYDataset createVolumeDataset() {
        ...
        // create dataset 2...
        TimeSeries series1 = new TimeSeries("销售量", Day.class);
